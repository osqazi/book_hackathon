...
async def lifespan(app: FastAPI):
    ...
    app.rag_system.initialize_vector_store()
    yield
    # Cleanup
...
async def chat_endpoint(request: ChatRequest):
    ...
    """
    try:
        if not app.rag_system.cohere_client:
        ...
        response_text, sources = app.rag_system.answer_query(
            query=request.query,
...
async def search_endpoint(
    ...
    """
    try:
        results = app.rag_system.search_documents(query, limit=limit)
